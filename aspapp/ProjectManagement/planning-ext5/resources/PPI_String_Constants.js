...
/* Tool Tip Constants*/
	...
	INVALID_STREAM_RATE = "Invalid Release Quantity. Reverted to old value.",
	INVALID_STREAM_OFFSET = "Invalid Frequency. Reverted to old value.",
	/*-----------------------Titles-----------------------------*/
...
var CUT_SUBTASK_TOOLTIP = "Cut selected subtask(s)",
    ...
    CREATE_SUBTASK_STREAM_TOOLTIP = "Create Subtask Stream",
    DELETE_SUBTASK_STREAM_TOOLTIP = "Delete Subtask Stream",
    DELETE_SUBTASK_TOOLTIP = "Delete selected subtask(s)";
    MOVE_STREAM_UP_TOOLTIP = "Move Stream Up";
    MOVE_STREAM_DOWN_TOOLTIP = "Move Stream Down";
...
var DEFAULT_STREAM_NAME = "New Stream";
var DEFAULT_STREAM_SUBTASK_NAME = "Subtask";

var RESOURCE_ROLL_UP_CAPPED_TO_MAX_UNITS = "Roll up of resources has been capped to its max units";
