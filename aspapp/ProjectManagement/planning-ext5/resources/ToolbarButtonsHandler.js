...
stl.app.initToolTips = function(){
    ...
    $(".subtask-header-createStream-icon").prop("title",CREATE_SUBTASK_STREAM_TOOLTIP);
    $(".subtask-header-deleteStream-icon").prop("title",DELETE_SUBTASK_STREAM_TOOLTIP);
    $(".stream-header-singlemoveup").prop("title",MOVE_STREAM_UP_TOOLTIP);
    $(".stream-header-singlemovedown").prop("title",MOVE_STREAM_DOWN_TOOLTIP);
